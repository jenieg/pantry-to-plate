...
const Main = () => {
    ...
    return (
        <main className="max-w-7xl pt-7 px-7">
            <form 
            ...
            <section aria-live="polite" className="flex justify-center mt-3">
                <ul className="max-w-3xl flex flex-wrap justify-center items-center gap-3 mt-5">
                    {ingredientsListItems}
                </ul>
                <div className="w-max flex sm:flex-row flex-col justify-between items-center rounded-lg bg-gray-200 px-5 py-2.5">
